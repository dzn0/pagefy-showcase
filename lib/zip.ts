// Monta um .zip no navegador, sem biblioteca: arquivos guardados sem
// compressão ("store"), que todo sistema abre. Serve pro download do site
// (HTML e imagens), onde as imagens já vêm comprimidas e o HTML é pequeno.
...
/** Data e hora no formato do DOS, que o zip usa. */
